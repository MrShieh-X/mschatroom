...
public class Variables {
    ...
    //默认服务器地址
    public static String DEFAULT_SERVER_ADDRESS = "xxx.xx.xx.xx";
    //默认服务器端口
    public static int DEFAULT_SERVER_PORT = 80;
    //默认MySQL数据库名称
    ...
    public static final String REAL_SHARED_PREFERENCE_SERVER_PORT = "server_port";
    ...
    //服务器端口
    public static int SERVER_PORT = MSCRApplication.getSharedPreferences().getInt(REAL_SHARED_PREFERENCE_SERVER_PORT,DEFAULT_SERVER_PORT);
    //MySQL数据库名称
    ...
    //发送验证码邮件的邮箱地址
    public static String CAPTCHA_EMAIL_ADDRESS = "xxxxx@xx.com";
    //发送验证码邮件的邮箱的授权码
    public static String AUTHENTICATOR = "XXXXXXXXXXX";
    //作者的网站
    ...
    public static final String SHARED_PREFERENCE_SERVER_PORT = REAL_SHARED_PREFERENCE_SERVER_PORT;
