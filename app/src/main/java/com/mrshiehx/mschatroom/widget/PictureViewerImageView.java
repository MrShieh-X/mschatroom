...
public class PictureViewerImageView extends ImageView implements View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener,
    ...
    private static final String TAG = "PictureViewerImageView";
    ...
    public PictureViewerImageView(Context context) {
        this(context, null);
    }

    public PictureViewerImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PictureViewerImageView(Context context, AttributeSet attrs, int defStyleAttr) {
