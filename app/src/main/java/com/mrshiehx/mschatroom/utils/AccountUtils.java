...
public class AccountUtils {
    ...
    public boolean tryLoginWithoutPasswordNoThread(Context context, String loginMethod, String accountOrEmail) {
        if (conn == null) {
            Log.i(Variables.TAG, "tryLoginWithoutPassword:conn is null");
            Toast.makeText(context, context.getResources().getString(R.string.toast_connect_failed), Toast.LENGTH_SHORT).show();
            return false;
    ...
    public int uploadAvatar(Context context, ProgressDialog ingDialog, String email,String account,String password, InputStream newAvatar) {
        if (conn == null) {
